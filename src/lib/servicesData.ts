export type NavItem = { id: string; title: string; shortTitle?: string };

export const servicesData: NavItem[] = [
  { id: "market-research", title: "Market Research and Opportunity Sizing", shortTitle: "Market Research" },
